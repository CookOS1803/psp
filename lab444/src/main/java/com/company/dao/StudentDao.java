...
public class StudentDao {
    ...
    public int insert(Student student) {
        ...
        try {
            ...
            ps.setDate(11, student.getAddDate());
            st = ps.executeUpdate();
    ...
    private void initializeStudent(Student student) throws SQLException {
        ...
        student.setAddDate(rs.getDate("add_date"));
    }
    ...
    public int deleteSubject(long nextLong) {
        con = ConnectionFactory.getConnection();
        try {
            String query = "delete from subjects where id=? ";
            ps = con.prepareStatement(query);
            ps.setLong(1, nextLong);
            st = ps.executeUpdate();
    ...
    public Subject fetchBySubjectId(long id) {
    ...
    private void initializeSubject(Subject subject) throws SQLException {
        subject.setId(rs.getLong("id"));
        subject.setName(rs.getString("name"));
    }

    public List<Subject> fetchBySubjectName(String name) {

        var subjectsList = new ArrayList<Subject>();
        ...
        try {
            ...
            String query = "select * from subjects where name like ?";
            ps = con.prepareStatement(query);
            ps.setString(1, name);
            rs = ps.executeQuery();
            while (rs.next()) {
